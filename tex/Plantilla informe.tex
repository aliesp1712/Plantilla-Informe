...
\fancyhead[L]{\footnotesize{\textbf{\textsf{Universidad de Chile \\ Facultad de Cs. F\'isicas y Matem\'aticas \\ Departamento de F\'isica \\ C\'odigo: Nombre del Ramo }}}}
...
% ---------------- Titulo.
\begin{center}
	\Large{\textbf{\textsf{Tarea - Informe $\text{N}^\text{o}$ X}}} \\
	\huge{\textbf{\textsf{Titulo}}}
\end{center}
